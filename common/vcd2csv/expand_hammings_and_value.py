...
#added for value section
hamming_col_names = [x for x in data.columns.values.tolist() if (x[0:2] != "d_"  and x!="Cycle" and x!="Benchmark") ]
...
for hamming_col_name in hamming_col_names:
    ...
    for i in range(1, distance+1):
        data.insert(col_idx, "v" + str(i) + "_" + hamming_col_name, distances)
